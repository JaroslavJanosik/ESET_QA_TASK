...
namespace EsetLogCollectorTestProject
{
    ...
    {
        private const string ProjectDirectoryPath = @"C:\ESET_QA_TASK\";
        ...
        private const string AllFilesCollectedMessage = "Všechny soubory byly úspìšnì sesbírány a zabaleny do archivu.";
        ...
        public void CollectData_CustomDirectory_RewriteArchive_Positive()
        {
            ...
            _logCollectorAppWindow.CollectButton.Click();
            _logCollectorAppWindow.HasModalDialogCorrectMessage(_logCollectorAppWindow.ModalDialogMessage, "Cílový soubor již existuje. Chcete jej pøepsat?");
        ...
        {
            var expectedDialogMessage = "Bìhem sesbírání souborù došlo k chybì. \r\n\r\nPro více informací se podívejte do protokolu.";
        ...
        {
            var interruptionStartDialogMessage = "Ukonèit proces?";
        ...
        {
            var expectedDialogMessage = "Neplatný limit stáøí protokolù.";
        ...
        {
            var expectedDialogMessage = "Neomezili jste stáøí protokolù.\r\nVýsledný soubor mùže být obrovský.\r\n\r\nChcete pokraèovat?";
        ...
        [Test]
        [TestCase("", "Název cílového archivu nemùže být prázdný.")]
        [TestCase("*", "")]
        [TestCase(@"C:\ESETQA_TASK\", "")]
        public void SaveArchiveTextFieldValidations(string testValue, string cannotBeEmptyMessage)
        {
            var expectedDialogMessage = "Cílový archiv nelze otevøít pro zápis.\r\n\r\nUjistìte se, zda máte potøebná oprávnìní pro pøístup k tomuto souboru, zda složka existuje, pøípadnì vyberte jiný soubor.";
